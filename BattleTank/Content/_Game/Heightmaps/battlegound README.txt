...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=battlegound&box=23.949464,61.576125,23.609758,61.414429
...
-----------
  ...
  * battlegound Height Map (ASTER 30m).png
  ...
  * battlegound Height Map (Merged).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * battlegound Height Map (SRTM30 Plus).png
